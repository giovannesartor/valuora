...
GUIDED_QUESTIONS = [
    {
        ...
        "description": "Dados básicos sobre a empresa do cliente",
        "fields": [
            {"key": "company_name", "label": "Nome da empresa", "type": "text", "required": True,
             "hint": "Qual o nome da empresa do seu cliente?"},
            {"key": "sector", "label": "Setor de atuação", "type": "text", "required": True,
             "hint": "Em qual setor a empresa atua? (Ex: Tecnologia, Varejo, Saúde)"},
            {"key": "cnpj", "label": "CNPJ", "type": "text", "required": False,
             "hint": "Informe o CNPJ se disponível"},
            {"key": "years_in_business", "label": "Anos de operação", "type": "number", "required": False,
             "hint": "Há valuos anos a empresa está em funcionamento?"},
        ],
    },
    {
        "step": 2,
        ...
        "description": "Receita, margem e EBITDA da empresa",
        "fields": [
            {"key": "revenue", "label": "Annual revenue ($)", "type": "currency", "required": True,
             "hint": "Qual a receita bruta anual da empresa?"},
            {"key": "net_margin", "label": "Margem líquida (%)", "type": "percentage", "required": True,
             "hint": "Qual % do faturamento sobra como lucro? (Ex: 15 para 15%)"},
            {"key": "ebitda", "label": "EBITDA ($)", "type": "currency", "required": False,
             "hint": "Se tiver, informe o EBITDA anual. Se não souber, deixe em branco."},
            {"key": "growth_rate", "label": "Crescimento anual (%)", "type": "percentage", "required": False,
             "hint": "A empresa cresceu valuo % no último ano?"},
        ],
    },
    {
        "step": 3,
        "id": "balance_sheet",
        "title": "Balanço",
        "description": "Dívidas, caixa e dependência do fundador",
        "fields": [
            {"key": "debt", "label": "Total debt ($)", "type": "currency", "required": False,
             "hint": "Quanto a empresa deve no total? (empréstimos, financiamentos)"},
            {"key": "cash", "label": "Available cash ($)", "type": "currency", "required": False,
             "hint": "Quanto tem em caixa/aplicações?"},
            {"key": "founder_dependency", "label": "Dependência do fundador (0-100%)", "type": "percentage", "required": False,
             "hint": "De 0 a 100%, valuo a empresa depende do dono? 100% = totalmente dependente"},
        ],
    },
    {
        "step": 4,
        ...
        "description": "Informações complementares para uma análise mais precisa",
        "fields": [
            {"key": "num_employees", "label": "Número de funcionários", "type": "number", "required": False,
             "hint": "Quantos funcionários a empresa tem?"},
            {"key": "recurring_revenue_pct", "label": "Receita recorrente (%)", "type": "percentage", "required": False,
             "hint": "Qual % da receita é recorrente/contratos? (Ex: assinaturas, mensalidades)"},
            {"key": "previous_investment", "label": "Previous investment ($)", "type": "currency", "required": False,
             "hint": "A empresa já recebeu investimento? Quanto?"},
        ],
    },
]

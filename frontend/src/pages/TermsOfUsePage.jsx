      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-6">
        ...
        <div className={sectionClass}>
          ...
          <p className={pClass}>
            ...
            <strong className={strongClass}>valuora.online</strong>, you declare that you have read, understood, and agree to these Terms of Use 
            and our <Link to="/privacy-policy" className="text-emerald-500 hover:underline font-medium">Privacy Policy</Link>.
          </p>
          <p className={pClass}>
        ...
        <div className={sectionClass}>
          ...
          <div className={`p-4 rounded-xl border mb-4 ${isDark ? 'bg-red-500/10 border-red-500/20' : 'bg-red-50 border-red-100'}`}>
            <p className={`text-sm ${isDark ? 'text-red-300' : 'text-red-800'}`}>
              <strong>Important:</strong> The valuation generated by the Platform is a <strong>technical estimate</strong> based on the information 
              provided by the user and from public data. <strong>It does not constitute financial, legal, or investment advice.</strong>
            </p>
          </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={pClass}>
            All content on the Platform — including source code, design, text, graphics, logos, algorithms, and calculation methodology — 
            is the exclusive property of <strong className={strongClass}>Valuora</strong> and is protected by intellectual property laws.
          </p>
          <p className={pClass}>
        ...
        <div className={sectionClass}>
          ...
          <p className={pClass}>
            Valuora reserves the right to modify these Terms of Use at any time. 
            Changes take effect on the date of publication of the updated version.
          </p>
          <p className={pClass}>
            We recommend periodic review of this document. Continued use of the Platform after publication of changes 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
          <Link to="/privacy-policy" className="text-sm text-emerald-500 hover:text-emerald-400 font-medium">
            Privacy Policy →
          </Link>
